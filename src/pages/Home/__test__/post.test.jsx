...
describe('Posts Component', () => {
  ...
  test('renders the first post with correct title ', () => {
    render(<Posts />);
    const firstPostTitle = screen.getByText(/Making a design system from scratch/i);
  ...
  test('renders the second post with correct title ', () => {
    render(<Posts />);
    const secondPostTitle = screen.getByText(/Creating pixel perfect icons in Figma/i);
  ...
  test('renders the first post description', () => {
    render(<Posts />);
    const firstPostDescription = screen.getAllByText(/Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet./i)[0];
    expect(firstPostDescription).toBeInTheDocument();
  });

  test('renders the second post description', () => {
    render(<Posts />);
    const secondPostDescription = screen.getAllByText(/Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet./i)[1];
